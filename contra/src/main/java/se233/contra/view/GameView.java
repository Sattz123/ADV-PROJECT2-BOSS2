...
public class GameView extends Canvas {
    ...
    public GameView(GameController gameController) {
        ...
        this.boss2Background = new Image(getClass().getResourceAsStream(Constants.BACKGROUND_BOSS2));
    ...
    private void renderGame() {
        ...
        // Draw boss
        if (gameController.getCurrentState() == GameController.GameState.BOSS_FIGHT) {
    ...
    private void drawBackground() {
        ...
        // ✅ Show boss2 background during boss2 fight or boss2 minion waves
        boolean isBoss2Stage =
                gameController.getBossStage() == 2 &&
                        (gameController.getCurrentState() == GameController.GameState.MINION_WAVE ||
                                gameController.getCurrentState() == GameController.GameState.BOSS_FIGHT ||
    ...
    private void renderVictory() {
        ...
        boolean intermission = gameController.isIntermissionAfterBoss1();
